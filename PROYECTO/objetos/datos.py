...
c1 = list(range(32,42)) + list(range(43,255+1)) + list(range(10,11)) + list(range(13,14))
c2 = list(range(32,42)) + list(range(43,47)) + list(range(48,255+1)) + list(range(10,11)) + list(range(13,14))
